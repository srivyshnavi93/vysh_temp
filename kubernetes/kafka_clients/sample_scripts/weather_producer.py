...
kafka_producer = KafkaProducer(bootstrap_servers = ['kafka-broker-1.kafka-broker.open-data-platform.svc.cluster.local:9092'], value_serializer = lambda x:dumps(x).encode('utf-8'))
